                ...
                <div className="flex flex-col md:flex-row gap-6 p-6 rounded-2xl bg-gradient-to-br from-purple-950/20 to-indigo-950/10 border border-purple-500/20 shadow-[0_0_40px_rgba(168,85,247,0.06)] hover:border-purple-500/40 hover:shadow-[0_0_50px_rgba(168,85,247,0.12)] transition-all duration-300 backdrop-blur-md">
                  ...
                  <div className="flex flex-col gap-3 flex-1">
                    ...
                    <p className="text-slate-500 text-sm">
                      {latest.movie.year} · {latest.movie.runtime} · ⭐{" "}
                      {latest.movie.rating}
                    </p>
                    ...
                    <div className="flex gap-2 mt-2 flex-wrap">
                      <button
                        ...
                        className={`px-4 py-2 rounded-full text-xs border transition-all duration-300 ${latest.liked === true ? "bg-purple-500/20 border-purple-500/50 text-purple-300" : "border-white/10 text-slate-400 hover:border-purple-500/30 hover:text-purple-300"}`}
                      >
                        ❤️ Curtir
                      </button>
                      <button
                        ...
                        className={`px-4 py-2 rounded-full text-xs border transition-all duration-300 ${latest.liked === false ? "bg-red-500/20 border-red-500/50 text-red-300" : "border-white/10 text-slate-400 hover:border-red-500/30 hover:text-red-300"}`}
                      >
                        👎 Não curtir
                      </button>
                      <button
                        ...
                        className={`px-4 py-2 rounded-full text-xs border transition-all duration-300 ${latest.watched ? "bg-indigo-500/20 border-indigo-500/50 text-indigo-300" : "border-white/10 text-slate-400 hover:border-indigo-500/30 hover:text-indigo-300"}`}
                      >
                        {latest.watched
                          ? "✅ Assistido"
                          : "🎬 Marcar assistido"}
